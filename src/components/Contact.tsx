      ...
      <div className="max-w-[1440px] mx-auto">
        ...
        <div className="px-5 sm:px-8 lg:px-12">
          ...
          <form
            ...
            className="relative overflow-hidden rounded-2xl sm:rounded-3xl p-6 sm:p-10 lg:p-12 max-w-[820px] mx-auto"
          >
            <img
              src={contactBg}
              alt=""
                ...
                {fields.map((f) => (
                  <label key={f.name} className="flex flex-col gap-2">
                    ...
                    <input
                      type={f.type ?? "text"}
                      required={f.required}
                      className="w-full rounded-xl border border-white/20 bg-white px-4 py-3 text-[14px] text-gray-900 outline-none focus:border-white transition-colors duration-300"
                    />
                  </label>
                ))}
              </div>
